/* LALIGURANS edge router v5 - _worker.js (guaranteed routing) */
...
async function handleProduct(request,env,path){
  ...
  try{
    ...
    return new Response(html,{headers:{"content-type":"text/html","cache-control":"public, max-age=60","x-seo-debug":"ok"}});
  }catch(e){
    return new Response(shell,{status:500,headers:{"content-type":"text/html","x-seo-debug":"error:"+String(e.message||e)}});
  }
}
...
async function handleCategory(request,env,path){
  ...
  try{
    ...
    if(!c)return new Response(`<!doctype html><meta name="robots" content="noindex"><title>Category Not Found</title><h1>404 — Category Not Found</h1><p><a href="/">Back to home</a></p>`,{status:404,headers:{"content-type":"text/html"}});
